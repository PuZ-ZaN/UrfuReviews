...
import CourseRowView from './Course/CourseRowView/CourseRowView';
import CourseColumnView from './Course/CourseColumnView/CourseColumnView';
import ModalWindow from './Course/ModalWindow/ModalWindow';
  ...
  return (
    <>
      ...
      {isRowView && selectedCourse && (
        <ModalWindow course={selectedCourse} closeModalWindow={closeModalWindow} />
      )}
    </>
  );
}
