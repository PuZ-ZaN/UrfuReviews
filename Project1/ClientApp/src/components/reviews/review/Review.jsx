          ...
          <div className='header_rates'>
            <div className='general_assessment'>
              ...
              <div className='stars'>
                <div
                  className={`star ${
                    review.rating >= 1 ? 'active' : ''
                  }`}></div>
                <div
                  className={`star ${
                    review.rating >= 2 ? 'active' : ''
                  }`}></div>
                <div
                  className={`star ${
                    review.rating >= 3 ? 'active' : ''
                  }`}></div>
                <div
                  className={`star ${
                    review.rating >= 4 ? 'active' : ''
                  }`}></div>
                <div
                  className={`star ${
                    review.rating >= 5 ? 'active' : ''
                  }`}></div>
              </div>
            </div>
            <div className='criterias'>
              <div className='criteria'>
                Интерес к предмету: {review.interest}
              </div>
              <div className='criteria'>
                Польза от предмета: {review.benefit}
              </div>
              <div className='criteria'>
                Доступность изложения: {review.availability}
              </div>
            </div>
          </div>
          ...
          <div className='review_ratings'>
            ...
            <div
              className={`rating_value ${
                usersRatingReview >= 0 ? 'useful' : 'useless'
              }`}>
              {usersRatingReview}
            </div>
            <div
              className={`dislike_button ${
                isDisLikedReview() ? 'disliked' : ''
              }`}
